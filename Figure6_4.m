...
hold on;
hh3=semilogx(1./resultsbeta0275(:,1),resultsbeta0275(:,2),'ok','Markersize',6,'Linewidth',6);
semilogx([0.0275 0.0275],[2 3.3],'b--','Linewidth',4);
hh2=semilogx(1./results(:,1),results(:,2),'or','Markersize',6,'Linewidth',6);
hl=legend([hh1,hh2,hh3],'M_s (true mean)','\beta=0 (standard)','\beta=0.275 (rescaled)');
set(hl,'interpreter','tex','Fontsize',28,'location','northeast');
